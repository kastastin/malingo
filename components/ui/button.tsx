...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold uppercase tracking-wide ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "border-2 border-b-4 border-slate-200 bg-white font-black text-slate-500 hover:bg-slate-100 active:border-b-2",

        ghost:
          "border-0 border-transparent bg-transparent text-slate-500 hover:bg-slate-100",

        primary:
          "bg-sky-400 border-b-4 border-sky-500 text-primary-foreground hover:bg-sky-400/90 active:border-b-0",
        primaryOutline: "bg-white text-sky-500 hover:bg-slate-100",

        secondary:
          "bg-green-500 border-b-4 border-green-600 text-primary-foreground hover:bg-green-500/90 active:border-b-0",
        secondaryOutline: "bg-white text-green-500 hover:bg-slate-100",

        danger:
          "bg-rose-500 border-b-4 border-rose-600 text-primary-foreground hover:bg-rose-500/90 active:border-b-0",
        dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",

        super:
          "bg-indigo-500 border-b-4 border-indigo-600 text-primary-foreground hover:bg-indigo-500/90 active:border-b-0",
